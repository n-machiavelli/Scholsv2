...
<xsl:stylesheet version="3.0"
	...
	<xsl:template name="layout_threecol">
	    ...
	    <section>
                ...
                <span class="section_top"><xsl:comment>Top</xsl:comment></span>
                <div class="section_mid">
                    <xsl:copy-of select="document/main-content[position()=2+$intro-offset]/node()" />
                </div>
                <span class="section_btm"><xsl:comment>Bottom</xsl:comment></span>
            </section>
	    ...
	    <section>
            	<xsl:attribute name="class">content<xsl:value-of select="3+$intro-offset" /></xsl:attribute>
                
                <span class="section_top"><xsl:comment>Top</xsl:comment></span>
                <div class="section_mid">
                    <xsl:copy-of select="document/main-content[position()=3+$intro-offset]/node()" />
                </div>
                <span class="section_btm"><xsl:comment>Bottom</xsl:comment></span>
            </section>
